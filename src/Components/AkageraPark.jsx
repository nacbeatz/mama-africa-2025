      ...
      <div className="container mx-auto px-4 py-8 font-coolvetica">
        ...
        <div className="flex justify-center mt-12">
          <motion.button
            ...
            className="mt-4 lg:mt-8 text-green-900 text-center bg-gradient-to-r from-[#D6ED07] to-yellow-300 hover:from-[#EDFF4F] hover:to-[#FFFF99] hover:text-black hover:font-normal font-bold py-2 px-4 lg:px-6 rounded-md transition duration-300 transform hover:scale-110 hover:shadow-lg shadow-[0_0_15px_#D6ED07] animate-pulse"
